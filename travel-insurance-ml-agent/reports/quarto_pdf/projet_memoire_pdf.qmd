...
## Modèle complet avec variables tarifaires
...
L'audit détaillé des données d'entraînement utilisées par stratégie est disponible en [Tableau B.2](#tab-b2-training-audit).
...
Le classement détaillé des modèles sans variables tarifaires est disponible en [Tableau B.6](#tab-b6-no-tariff-ranking).
